...
export default function Dialog({ open, onClose, title, children, maxWidth = 'max-w-lg' }: DialogProps) {
  ...
  return (
    ...
    >
      <div className="fixed inset-0 bg-background/78 backdrop-blur-md" />
      <div className={`relative w-full ${maxWidth} max-h-[90vh] overflow-y-auto rounded-[28px] border border-border/80 bg-[linear-gradient(180deg,hsl(var(--surface))/0.98,hsl(var(--surface-raised))/0.96)] shadow-[0_40px_120px_-60px_rgba(0,0,0,0.95)]`}>
