...
export default class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      // Default fallback UI
      return (
        <Card className="mx-auto max-w-2xl rounded-2xl border-border/70">
          <div className="p-8 text-center sm:p-10">
            <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl border border-destructive/20 bg-destructive/[0.12] text-destructive">
